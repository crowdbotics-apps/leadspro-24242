"""leadspro_24242 URL Configuration
...
admin.site.site_header = "Leadspro"
admin.site.site_title = "Leadspro Admin Portal"
admin.site.index_title = "Leadspro Admin"

# swagger
api_info = openapi.Info(
    title="Leadspro API",
    default_version="v1",
    description="API documentation for Leadspro App",
)
